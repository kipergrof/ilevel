...
public class PaintingAdapterSetting extends BaseAdapter {
    private ILevelApplication application;
    private Context context;
    private List<String> list;

    public PaintingAdapterSetting(Context context2, List<String> list2, ILevelApplication application2) {
